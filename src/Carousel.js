    ...
    <Carousel>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p className="card-slogan">
            Middle of the road in taste and price, but HEY its still melted
            cheese..am I right?
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p className="card-slogan">
            Workhorse. Always good, cheap, and accessible. Can be a little on
            the cold side{" "}
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <h4>North County</h4>
          <p className="card-slogan">
            #1 favorite! The Cheese is more of a stringy consistency. A little
            Pricy, but WORTH it
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <h4>Fuzzy's Tacos</h4>
          <p className="card-slogan">
            Best bang for your buck! Plus who doesn't like it BEEFY
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p className="card-slogan">
            Great option for those who keep it SPICY! Pairs well with some boozy
            Margaritas
          </p>
        </Carousel.Caption>
      </Carousel.Item>
